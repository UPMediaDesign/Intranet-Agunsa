        ...
        <div class="row">
            ...
            <article class="col-md-7 col-sm-7 col-xs-12 single-content">
                <div class="breadcrumb">
                    <a href="<?php echo get_bloginfo('home_url');?>">Home » </a><a href="<?php echo get_bloginfo('home_url');?>/category/noticias">Noticias</a> » <strong>Nueva Intranet Corporativa Agunsa</strong>
                </div>
